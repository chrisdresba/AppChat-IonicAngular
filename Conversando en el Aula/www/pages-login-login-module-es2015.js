...
/* harmony import */ var src_app_class_usuario__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/class/usuario */ "Jb31");
/* harmony import */ var src_app_services_creditos_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/services/creditos.service */ "p13/");
...
let LoginPage = class LoginPage {
    constructor(authService, router, fromBuilder, toastController, loadingController, afAuth, creditosSrv) {
    ...
    ngOnInit() {
        this.loginForm = this.fromBuilder.group({
            ...
            password: [
                "",
                _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].maxLength(6)]),
            ],
        });
    }
    Login() {
        ...
        this.afAuth.signInWithEmailAndPassword(this.email, this.password)
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["timer"])(2000).subscribe(() => { this.router.navigate(['/home']); });
        })
            .catch((err) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CreditosService", function() { return CreditosService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
let CreditosService = class CreditosService {
    constructor(firestore) {
        ...
        this.getCreditos = () => {
            return this.firestore.collection('creditos').snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(docs => {
                return docs.map(d => d.payload.doc.data());
            }));
        };
    ...
    actualizarCredito(res) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return yield this.firestore.collection('creditos').doc(res.id).update(Object.assign({}, res));
        });
    }
};
CreditosService.ctorParameters = () => [
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
];
CreditosService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
