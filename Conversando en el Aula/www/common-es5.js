(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    /***/
    function h9oc(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var MensajeService = /*#__PURE__*/function () {
        function MensajeService(firestore) {
          var _this = this;
          ...
          this.getMensajesA = function () {
            return _this.firestore.collection('sala-a').snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (docs) {
          ...
          this.getMensajesB = function () {
            return _this.firestore.collection('sala-b').snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (docs) {
              return docs.map(function (d) {
                return d.payload.doc.data();
              });
            }));
          ...
          this.getMensajesA().subscribe(function (item) {
            _this.chatsA = item;
          });
          this.getMensajesB().subscribe(function (item) {
            _this.chatsB = item;
          });
        }
        ...
        _createClass(MensajeService, [{
          key: "guardarMensajeA",
          value: function guardarMensajeA(usuario, mensaje) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
              var fecha, dia, hora, referencia, texto;
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      ...
                      hora = fecha.getHours() + ':' + this.revision(fecha.getMinutes()) + ':' + this.revision(fecha.getSeconds());
                      referencia = fecha.getHours() * 3600 + fecha.getMinutes() * 60 + fecha.getSeconds();
                      texto = {
                        'usuario': usuario,
                        'fecha': dia,
                        'hora': hora,
                      ...
                      _context3.next = 7;
                      return this.firestore.collection('sala-a').add(texto);
          ...
          key: "guardarMensajeB",
          value: function guardarMensajeB(usuario, mensaje) {
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      ...
                      _context4.next = 7;
                      return this.firestore.collection('sala-b').add(texto);
      ...
      MensajeService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], MensajeService);
      /***/
    },
    ...
    function lGQG(module, __webpack_exports__, __webpack_require__) {
      ...
      /*! rxjs/operators */
      "kU1M"); //import { auth } from 'firebase/app/';
      ...
      var AuthService = /*#__PURE__*/function () {
        function AuthService(afStore, ngFireAuth, router, ngZone) {
          ...
          this.router = router;
          this.ngZone = ngZone;
          this.user$ = this.ngFireAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (user) {
            if (user) {
              return _this2.afStore.doc("users/".concat(user.uid)).valueChanges();
            }
        ...
        _createClass(AuthService, [{
          ...
          key: "getUserRol",
          value: function getUserRol(uid) {
            return this.afStore.doc("users/".concat(uid)).valueChanges();
          } // Sign-out
          ...
          value: function getCurrentUserId() {
            return this.ngFireAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["first"])());
          }
        }]);
