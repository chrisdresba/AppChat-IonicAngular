...
let MensajeService = class MensajeService {
    constructor(firestore) {
        ...
        this.chatsB = [];
        this.getMensajesA = () => {
            return this.firestore.collection('sala-a').snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(docs => {
                return docs.map(d => d.payload.doc.data());
            }));
        };
        this.getMensajesB = () => {
            return this.firestore.collection('sala-b').snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(docs => {
                return docs.map(d => d.payload.doc.data());
            }));
        };
    ...
    guardarMensajeA(usuario, mensaje) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            return yield this.firestore.collection('sala-a').add(texto);
        });
    }
    guardarMensajeB(usuario, mensaje) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let fecha = new Date();
            let dia = fecha.getFullYear() + '-' + (fecha.getMonth() + 1) + '-' + fecha.getDate();
            let hora = fecha.getHours() + ':' + this.revision(fecha.getMinutes()) + ':' + this.revision(fecha.getSeconds());
            let referencia = (fecha.getHours() * 3600) + (fecha.getMinutes() * 60) + fecha.getSeconds();
            let texto = { 'usuario': usuario, 'fecha': dia, 'hora': hora, 'mensaje': mensaje, 'referencia': referencia };
            return yield this.firestore.collection('sala-b').add(texto);
        });
    }
    revision(dato) {
        if (dato < 10) {
...
MensajeService.ctorParameters = () => [
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
];
MensajeService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
let AuthService = class AuthService {
    constructor(afStore, ngFireAuth, router, ngZone) {
        ...
        this.router = router;
        this.ngZone = ngZone;
        this.user$ = this.ngFireAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])((user) => {
            if (user) {
